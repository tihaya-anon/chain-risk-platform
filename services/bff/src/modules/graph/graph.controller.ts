...
export class GraphController {
  ...
  async getAddressInfo(
    ...
    logger.debug("Getting address info from graph", {
      address,
      userId: user.sub,
    });
  ...
  @ApiResponse({
    status: 200,
    description: "Address neighbors",
    type: AddressNeighborsResponse,
  })
  ...
  async getAddressNeighbors(
    ...
    logger.debug("Getting address neighbors", {
      address,
      ...query,
      userId: user.sub,
    });
    return this.graphService.getAddressNeighbors(
      address,
      query.depth,
      query.limit,
    );
  ...
  async addAddressTags(
    ...
    logger.info("Adding tags to address", {
      address,
      tags: request.tags,
      userId: user.sub,
    });
  ...
  async removeAddressTag(
    ...
    logger.info("Removing tag from address", {
      address,
      tag,
      userId: user.sub,
    });
  ...
  async manualCluster(
    ...
    logger.info("Creating manual cluster", {
  ...
  @ApiResponse({
    ...
    type: PropagationResultResponse,
  })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  async propagateTags(
    @GatewayUser() user: UserPayload,
