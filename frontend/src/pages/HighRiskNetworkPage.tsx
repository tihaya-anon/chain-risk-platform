...
export function HighRiskNetworkPage() {
  ...
  useEffect(() => {
    ...
    // For demo, create some random edges between high-risk addresses
    // In production, you'd fetch actual connections
    const edges: Array<{
      id: string
      from: string
      to: string
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">High Risk Network</h1>
          ...
          <div className="flex items-center gap-2 border-l pl-4">
            ...
            <div className="flex rounded-md overflow-hidden border border-gray-300">
              ...
              <button
                ...
                className={`px-3 py-1.5 text-sm ${viewMode === 'graph'
                  ? 'bg-blue-600 text-white'
                  : 'bg-white text-gray-700 hover:bg-gray-50'
                  }`}
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">Unique Clusters</p>
            </div>
          </Card>
        </div>
      )}
