    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card title="Risk Distribution" subtitle="By category">
          <div className="space-y-4">
            {[
              { label: 'Blacklisted', count: 234, color: 'bg-red-500' },
              { label: 'High Frequency', count: 567, color: 'bg-orange-500' },
              { label: 'Large Transactions', count: 890, color: 'bg-yellow-500' },
              { label: 'New Addresses', count: 1234, color: 'bg-blue-500' },
            ].map((item, i) => (
