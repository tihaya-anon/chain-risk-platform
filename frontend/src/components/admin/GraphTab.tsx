          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span
                  className={`inline-block mt-1 px-2 py-0.5 text-xs font-medium rounded-full ${getStatusColor(status?.status)}`}
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-blue-900">
                {status?.totalAddresses?.toLocaleString() || "-"}
              </p>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-900">
                {status?.totalTransfers?.toLocaleString() || "-"}
              </p>
            </div>
            <div className="p-4 bg-orange-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-orange-900">
                {status?.lastSyncedBlock?.toLocaleString() || "-"}
              </p>
            </div>
