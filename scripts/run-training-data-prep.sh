#!/bin/bash
# ============================================================
# Run Training Data Prepare Job
# ============================================================
# Joins address_features with address_labels to create training_dataset
#
# Usage:
#   ./scripts/run-training-data-prep.sh
#   NETWORK=ethereum ./scripts/run-training-data-prep.sh
# ============================================================
...
log_info "=== Training Data Prepare Job ==="
...
# Run the job
log_info "Starting training data preparation..."

java -cp "$BATCH_JAR" \
    -Dlog4j.configuration=file:"$PROJECT_ROOT/processing/batch-processor/src/main/resources/log4j.properties" \
    com.chainrisk.batch.BatchProcessorApp training

log_success "Training data preparation completed!"
